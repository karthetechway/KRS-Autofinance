        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {customers.slice(-5).reverse().map((c) => (
              <div key={c.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px', background: 'rgba(255,255,255,0.02)', borderRadius: '14px', border: '1px solid var(--border)' }}>
            ...
            {customers.length === 0 && <p className="text-muted" style={{ textAlign: 'center', padding: '32px', fontSize: '16px' }}>Awaiting initial records</p>}
          </div>
        </div>
